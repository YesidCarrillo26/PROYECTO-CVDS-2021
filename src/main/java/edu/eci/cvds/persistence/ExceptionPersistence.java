...
public class ExceptionPersistence extends Exception {
    ...
    public ExceptionPersistence(Throwable cause) {
        super(cause);
    }

    public ExceptionPersistence(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
